...
function AdContent(url, pic, width, height)
{
	...
	if (picType == "swf")
	{
		...
		if (url != "")
			if (hasButton)
				content = "<span style='z-index:1;position:absolute;'><a href='" + url + "' target='_blank'><img src='"+js_path+"/blank.gif' width='" + width + "' height='" + height + "' /></a><span style='position:absolute; top:0; right:0;'><img src='"+js_path+"/closed.gif' /></span></span>" + content;
			else
				content = "<span style='z-index:1;position:absolute;'><a href='" + url + "' target='_blank'><img src='"+js_path+"/blank.gif' width='" + width + "' height='" + height + "' /></a></span>" + content;
		else
			content = "<span style='z-index:1;position:absolute;'><img src='"+js_path+"/blank.gif' width='" + width + "' height='" + height + "' /></span>" + content;
	}
	else
	{
		...
		if (url != "")
			if (hasButton)
				content = "<a href='" + url + "' target='_blank'>" + content + "</a><span style='position:absolute; top:0; right:0;'><img src='"+js_path+"/closed.gif' /></span></span>";
			else
