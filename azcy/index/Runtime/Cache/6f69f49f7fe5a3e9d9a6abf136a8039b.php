...
$(".breadcrumbs a:last").addClass("current");
				...
				<p><img src="__PUBLIC__/images/ico_08.jpg" width="710" height="100"></p>
<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="hrTable">
	<tr class="hrTableTh">
		<th align="left">招聘岗位</th>
		<th width="160">发布时间</th>
		<th width="100">详情</th>
	</tr>
	<?php if(is_array($infos)): foreach($infos as $key=>$v): ?><tr class="">
		<td class="c"><?php echo ($v["name"]); ?>（<?php echo ($v["num"]); ?>人）</td>
		<td align="center"><?php echo (date("Y.m.d",strtotime($v["publishdate"]))); ?></td>
		<td align="center"><a href="<?php echo U('HR/displayJob',array('id'=>$v['id']));?>" class="p">我要应聘</a></td>
	</tr><?php endforeach; endif; ?>
	
</table>
<script>
$(function(){
	$(".hrTable tr").hover(function(){
		$(this).addClass("hover");
	},function(){
